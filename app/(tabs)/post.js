...
const API_KEY =
  "cv_TQBPOM6hYvO_NCzpyh8A0Cr_l6wQFo71wH3lHewIHs6bo_OaDXjaLNAGqtld51HK";
  ...
  async function criarAnime() {
    ...
    try {
      const resposta = await api.post("/api/animes", {
        ...
        numero_episodios: parseInt(numero_de_episodios),
      });
